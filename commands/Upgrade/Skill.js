    ...
    async execute(interaction) {
        ...
        for (let i = 0; i < length; i++){
            if (gambling_find.skills[i].name == args) {
                ...
                hasitem.push({"name": gambling_find.skills[i].name, "Lv": gambling_find.skills[i].Lv})
            }
        }
        ...
        interaction.reply({embeds: [embed]});
            ...
            for (let i = 0; i < length; i++){
                if (gambling_find.skills[i].name == args) {
                    ...
                    soondeleteitem.push({"name": gambling_find.skills[i].name, "Lv": gambling_find.skills[i].Lv})
                }
            }
