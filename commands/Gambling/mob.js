...
/**
    ...
    async execute(interaction) {
        ...
        if (Isauto == true) {
                if (interaction.user.id != '929974091614670938' && interaction.user.id != '981354358383984680'&& interaction.user.id != '1040957953932533790') {
        ...
        if (level_find?.level > 2000){
            ...
            monsters = [
                { name: '천상의 죽음', hp: 100000, reward: 10000000, XPreward:40 },
                { name: '천상의 최강의 슬라임', hp: 5200, reward: 260000, XPreward:36 },
                { name: '천상의 최강의 새늅봇', hp: 5200, reward: 260000, XPreward: 36 },
                { name: '천상의 GPT', hp: 4800, reward: 240000, XPreward:32 },
                { name: '천상의 사이보그', hp: 4000, reward: 200000, XPreward:28 },
                { name: '천상의 봇', hp: 4000, reward: 200000, XPreward:28 },
                { name: '천상의 ks', hp: 4000, reward: 100000, XPreward:28 },
                { name: '천상의 파이어드래곤', hp: 2800, reward: 140000, XPreward:24 },
                { name: '천상의 워터드래곤', hp: 2400, reward: 120000, XPreward:20 },
                { name: '천상의 라이트닝드래곤', hp: 2400, reward: 120000, XPreward:20 },
                { name: '천상의 드래곤', hp: 2000, reward: 100000, XPreward:20 },
                { name: '천상의 로즈', hp: 1200, reward: 60000, XPreward:16 },
                { name: '천상의 애기드래곤', hp: 1200, reward: 60000, XPreward:16 },
                { name: '천상의 전설의 용사', hp: 1000, reward: 20000, XPreward:16 },
                { name: '천상의 새늅봇', hp: 8000, reward: 10000, XPreward:12 },
                { name: '천상의 새뉴비', hp: 800, reward: 10000, XPreward:12 },
                { name: '천상의 껌', hp: 500, reward: 500, XPreward:8 },
                { name: '천상의 lk', hp: 300, reward: 2500, XPreward:8 },
                { name: '천상의 슬라임', hp: 200, reward: 1000, XPreward:8 },
