            ...
            if (bools == true){
                ...
                if (((10000 + (level_find?.level || 1) * 100) - (_find.hashtags[isitem].value ** 2)) / 100 >= 3000){
                    ...
                    await gambling_Schema.updateOne(
                        ...
                        {$set:{
                        hashtags : hasitem2,
                        skills: _find?.skills || [], cooltime: Date.now(), defense: _find?.defense || 0}},
                        {upsert:true}
                    );
                ...
                if (random_number + (level_find?.level || 1) * 100 > _find.hashtags[isitem].value ** 2){
                    ...
                    interaction.channel.send({embeds: [embed]});
                        ...
                        await gambling_Schema.updateOne(
                            ...
                            skills: _find?.skills || [], cooltime: Date.now(), defense: _find?.defense - 1}},
                            {upsert:true}
                        );
                ...
                if (((10000 + (level_find?.level || 1) * 100) - (gambling_find.hashtags[isitem].value ** 2)) / 100 >= 3000){
                    ...
                    await gambling_Schema.updateOne(
                        ...
                        {$set:{
                        hashtags : hasitem,
                        skills: gambling_find?.skills || [], cooltime: Date.now(), defense: gambling_find?.defense || 0}},
                        {upsert:true}
                    );
                ...
                if (random_number + (level_find?.level || 1) * 100 > gambling_find.hashtags[isitem].value ** 2){
                    ...
                    interaction.reply({embeds: [embed]});
                        ...
                        await gambling_Schema.updateOne(
                            ...
                            skills: gambling_find?.skills || [], cooltime: Date.now(), defense: gambling_find?.defense - 1}},
                            {upsert:true}
                        );
